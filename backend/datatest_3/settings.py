"""
Django settings for datatest_3 project.
...
WSGI_APPLICATION = 'datatest_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "datatest_3 API",
    "DESCRIPTION": "API documentation for datatest_3 App",
    "VERSION": "v1",
}
